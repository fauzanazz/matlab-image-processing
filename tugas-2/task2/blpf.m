function [output, H, spectrum] = blpf(f, D0, n, usePadding)
% BLPF - Butterworth Low-Pass Filter dalam ranah frekuensi
%
% Syntax:
%   [output, H, spectrum] = blpf(f, D0, n, usePadding)
%
% Input:
...
%
% Formula BLPF (Slide 27):
%   H(u,v) = 1 / (1 + [D(u,v)/D0]^(2n))
%   dimana D(u,v) = sqrt((u - M/2)^2 + (v - N/2)^2)
%
% Parameter n mengontrol ketajaman transisi:
%   - n kecil (1): transisi landai
%   - n besar (4,8): transisi tajam, mendekati ILPF
