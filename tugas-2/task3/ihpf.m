function [output, H, spectrum] = ihpf(f, D0, usePadding)
% IHPF - Ideal High-Pass Filter dalam ranah frekuensi
%
% Syntax:
%   [output, H, spectrum] = ihpf(f, D0, usePadding)
%
% Input:
